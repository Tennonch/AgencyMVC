...
namespace AgencyInfrastructure.Controllers
{
    public class PropertyTypesController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            return RedirectToAction("Index", "Properties", new { id = propertyType.Id, name = propertyType.TypeName});
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,TypeName")] PropertyType propertyType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TypeName")] PropertyType propertyType)
        {
